...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"TakeTaxiDemo","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var MapMixins = function (_super) {
  __extends(MapMixins, _super);
  function MapMixins() {
  ...
  MapMixins.prototype.onClearPlanRoute = function () {
    this.planRoute = {};
    this.markers = [];
    this.routePolyline = [];
  };
  MapMixins.prototype.getLocation = function () {
    var _this = this;
  ...
  MapMixins.prototype.drawRoutePolyline = function (targetInfo) {
    var _this = this;
  ...
  MapMixins.prototype.getPositionInfoByAddress = function (address) {
    var _this = this;
    this.showLoadingToast();
    return new Promise(function (resolve, reject) {
  ...
  MapMixins.prototype.routePolylinePlan = function (_a, mode) {
    var _this = this;
  ...
  MapMixins = __decorate([
  vue_property_decorator_1.Component({ name: 'MapMixins' })],
  MapMixins);
  return MapMixins;
}(vue_property_decorator_1.Mixins(VueMixins_1["default"], vue_property_decorator_1.Vue));
exports["default"] = MapMixins;
;
...
/* harmony import */ var vue_class_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue-class-component */ 21);
...
exports.__esModule = true;
var vue_property_decorator_1 = __webpack_require__(/*! vue-property-decorator */ 20);
var QQMapsSDKStatusEnum;
(function (QQMapsSDKStatusEnum) {
  QQMapsSDKStatusEnum[QQMapsSDKStatusEnum["success"] = 0] = "success";
})(QQMapsSDKStatusEnum = exports.QQMapsSDKStatusEnum || (exports.QQMapsSDKStatusEnum = {}));
var LoadMoreStatusEnum;
(function (LoadMoreStatusEnum) {
  LoadMoreStatusEnum["more"] = "\u52A0\u8F7D\u66F4\u591A";
  LoadMoreStatusEnum["loading"] = "\u52A0\u8F7D\u4E2D";
  LoadMoreStatusEnum["noMore"] = "\u6CA1\u6709\u66F4\u591A\u6570\u636E";
})(LoadMoreStatusEnum = exports.LoadMoreStatusEnum || (exports.LoadMoreStatusEnum = {}));
var VueMixins = function (_super) {
  __extends(VueMixins, _super);
  function VueMixins() {
    var _this = _super !== null && _super.apply(this, arguments) || this;
    _this.StatusBar = _this.StatusBar;
    _this.CustomBar = _this.CustomBar;
    _this.ScreenHeight = _this.ScreenHeight;
    _this.ScreenWidth = _this.ScreenWidth;
    _this.qqMapsSDKStatusEnum = QQMapsSDKStatusEnum;
    _this.loadMoreStatusEnum = LoadMoreStatusEnum;
    _this.appid = 'wx204f2188a505d169';
    _this.secret = '559cb80e07cf9063b4ddd82e409dbb7b';
    _this.js_code = '';
    _this.loadMoreStatus = _this.loadMoreStatusEnum.more;
    _this.spinning = false;
    return _this;
  }
  VueMixins.prototype.getAuthorize = function (scope) {
    if (scope) {
      return new Promise(function (resolve, reject) {
        uni.authorize({
          scope: scope,
  ...
  ;
  VueMixins.prototype.onPhoneCall = function (phoneNumber) {
    if (phoneNumber) {
      uni.makePhoneCall({
  ...
  VueMixins.prototype.showLoadingToast = function (title) {
    if (title === void 0) {title = '加载中...';}
    uni.showLoading({ title: title, mask: true });
  };
  VueMixins.prototype.hideLoadingToast = function () {
    uni.hideLoading();
  };
  VueMixins.prototype.showErrorToast = function (error) {
    uni.showToast({
      title: error.message,
      icon: 'error',
      duration: 2000 });
  ...
  VueMixins.prototype.onReady = function () {
  };
  VueMixins.prototype.onLoad = function () {
  };
  VueMixins.prototype.handleSpinningChange = function (newVal, oldVal) {
    if (newVal !== oldVal) {
      if (newVal) {
        this.showLoadingToast();
      } else
  ...
  __decorate([
  vue_property_decorator_1.Watch('spinning')],
  VueMixins.prototype, "handleSpinningChange");
  VueMixins = __decorate([
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });Object.defineProperty(exports, "OrderService", { enumerable: true, get: function get() {return _order.default;} });exports.mapApi = void 0;var _order = _interopRequireDefault(__webpack_require__(/*! ./order */ 32));
var _mapApi = _interopRequireDefault(__webpack_require__(/*! ./mapApi */ 38));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _qs = _interopRequireDefault(__webpack_require__(/*! qs */ 33));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

var OrderService = {
  //获取order的列表
  fetchOrderList: function fetchOrderList(params, urlParams) {
    var url = "".concat(uni.getStorageSync('$apiServer'), "/api/OrderInfo/GetPageList");
    if (urlParams) {
...
var parse = __webpack_require__(/*! ./parse */ 37);
var formats = __webpack_require__(/*! ./formats */ 36);
...
MapApi = (_dec = (0, _vuePropertyDecorator.Component)({ name: 'MapApi' }), _dec(_class = /*#__PURE__*/function (_Mixins) {_inherits(MapApi, _Mixins);var _super = _createSuper(MapApi);function MapApi() {_classCallCheck(this, MapApi);return _super.apply(this, arguments);}_createClass(MapApi, [{ key: "getLocation",
    ...
    //绘制规划路线
  }, { key: "drawRoutePolyline", value: function drawRoutePolyline(targetInfo) {var _this2 = this;var
      ...
      if (location) {var
        ...
        then(function (from) {
          ...
          then(function (planRoute) {
            _this2.planRoute = _objectSpread(_objectSpread({}, _this2.planRoute), planRoute);
          });
        });
      }
    }
    ...
    //通过地址返回坐标位置信息
  }, { key: "getPositionInfoByAddress", value: function getPositionInfoByAddress(address) {var _this3 = this;
      this.showLoadingToast();
      return new Promise(function (resolve, reject) {
        //调用地址解析接口
        _this3.$qqmapsdk.geocoder({
          //获取表单传入地址
          address: address, //地址参数，例：固定地址，address: '北京市海淀区彩和坊路海淀西大街74号'
          success: function success(res) {//成功后的回调
            var _res$result$location =
            ...
            res.result.location,lat = _res$result$location.lat,lng = _res$result$location.lng,status = res.status;
            if (status === _this3.qqMapsSDKStatusEnum.success) {
              return resolve({
                latitude: lat,
                longitude: lng });
          ...
          fail: function fail(error) {
            console.error(error);
            _this3.showErrorToast(error);
            return reject(error);
          },
          complete: function complete(res) {
            _this3.hideLoadingToast();
            console.log(res);
          } });
    ...
    //路线规划
  }, { key: "routePolylinePlan", value: function routePolylinePlan(_ref)



    {var _this4 = this;var from = _ref.from,to = _ref.to,targetInfo = _ref.targetInfo;var mode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'driving';
      this.markers = [];
      this.routePolyline = [];
      this.showLoadingToast();
      return new Promise(function (resolve, reject) {
        ...
        _this4.$qqmapsdk.direction({
          ...
          success: function success(res) {var
            ...
            res.result.routes,status = res.status;
            if (status === _this4.qqMapsSDKStatusEnum.success) {var _routes = _slicedToArray(
              routes, 1),route = _routes[0];
              //距离和预计用时
              var
              distance =
              ...
              //将解压后的坐标放入点串数组pl中
              for (var _i2 = 0; _i2 < coors.length; _i2 += 2) {
                pl.push({
                  latitude: coors[_i2],
                  longitude: coors[_i2 + 1] });

              }
              console.log(pl);var
              startPoint = pl[0];
              var endPoint = pl[pl.length - 1];
              _this4.latitude = startPoint.latitude;
              _this4.longitude = startPoint.longitude;
              ...
              _this4.markers = [{
                ...
                longitude: startPoint.longitude,
                iconPath: '../../static/startPoint_icon.png',
                width: _this4.markerHeight, //宽
                height: _this4.markerHeight //高
              }, {
                id: 'endPoint',
                latitude: endPoint.latitude,
                longitude: endPoint.longitude,
                ...
                callout: {
                  content: "".concat(targetInfo.title || '', "\n \u8DDD\u79BB\uFF1A").concat(distance || 0, "\u7C73 | \u7EA6\u9700\u8981").concat(duration || 0, "\u5206\u949F\u5230\n\u5730\u5740\uFF1A").concat(targetInfo.address || '', "\n"),
                  color: '#FFFFFF',
                  fontSize: 12,
                  borderRadius: 4,
                  borderWidth: 1,
          ...
          fail: function fail(error) {
            console.error(error);
            _this4.showErrorToast(error);
            return reject(error);
          },
          complete: function complete(res) {
            _this4.hideLoadingToast();
            console.log(res);
          } });

      });
    } }]);return MapApi;}((0, _vuePropertyDecorator.Mixins)(_VueMixins.default, _vuePropertyDecorator.Vue))) || _class);exports.default = MapApi;
;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
